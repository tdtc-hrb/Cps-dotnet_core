...
namespace Cps_x35.Models
{
    ...
    {
        [Column("total_weight", TypeName = "decimal(9, 3)")]
        ...
        [Column("carry_weight", TypeName = "decimal(9, 3)")]
        public decimal CarryWeight { get; set; }
        [Column("self_weight", TypeName = "decimal(9, 3)")]
        public decimal SelfWeight { get; set; }
        [Column("pl_weight", TypeName = "decimal(9, 3)")]
